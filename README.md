...
> 
> /*
>   $_["component"].box("Text", "Type", "CSS classes", "Close", "ID");
>   Type: primary | secondary | success | danger | warning | info | light | dark
>   Close: true | false
> */
> 
> $_["component"].box("Message...", "primary");
> $_["component"].box("Message...", "primary", "m-2 p-2 shadow");
> $_["component"].box("Message...", "primary", "", true);
> $_["component"].box("Message...", "primary", "m-2 p-2 shadow", true);
> $_["component"].box("Message...", "primary", "m-2 p-2 shadow", true, "#myid");
> 
> $_["component"].dialog
> $_["component"].icon
> ```
