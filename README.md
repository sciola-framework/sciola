...
> });
> 
> // Overwrite current document with HTML data<br>
> $_["document"].html("data");
> 
> // Get document height<br>
> $_["document"].height();
> 
...
> $_["document"].error(function (info) {<br>
>     // info.message | info.file | info.line | info.col | info.error<br>
>     console.log(info);<br>
> });
> 
<br>
