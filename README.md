...
> 
> $_["component"].box("Text...", "primary"); // Background color - primary | secondary | success | danger | warning | info | light | dark
> $_["component"].box("Text...", "primary", true); // Close button - true | false
> $_["component"].box("Text...", "primary", true, "m-2 p-2 shadow"); // CSS classes
> $_["component"].box("Text...", "primary", true, "m-2 p-2 shadow", "#myid"); // ID of the element where the message box will be displayed
> 
> $_["component"].dialog
> $_["component"].icon
> ```
